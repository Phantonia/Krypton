...
namespace Krypton.Analysis.Syntax
{
    internal sealed class ProgramParser
    {
        ...
        internal FunctionDeclarationNode? ParseFunctionDeclaration()
        {
            ...
            {
                analyser.ReportError(DiagnosticsCode.ExpectedOpenParenthesis, tokens[index]);
                return null;
            }
                 ...
                 SyntaxCharacterToken? closingParenthesis) ParseParameterList()
        {
            ...
            while (true)
            {
                ...
                {
                    analyser.ReportError(DiagnosticsCode.ExpectedKeywordAs, tokens[index]);
                    return (null, null, null);
                }
                ...
                switch (tokens[index])
                {
                    ...
                    default:
                        analyser.ReportError(DiagnosticsCode.ExpectedCommaOrClosingParenthesis, tokens[index]);
                        return (null, null, null);
                }
            }
        }
