    ...
    partial class StatementParser
    {
        private StatementNode? ParseExpressionStatement(ref int index)
        {
            ...
            return expression switch
            {
                ...
                IdentifierExpressionNode identifierExpression => ParseVariableAssignmentStatement(ref index, identifierExpression.IdentifierToken, expression),
                _ => Error(),
            };
        ...
        private ExpressionStatementNode? ParseFunctionCallStatement(InvocationExpressionNode expression, ref int index)
        {
            ...
            {
                analyser.ReportError(DiagnosticsCode.ExpectedSemicolon, tokens[index]);
                return null;
            }
        }
        ...
        private VariableDeclarationStatementNode? ParseVariableDeclarationStatement(ref int index, ReservedKeywordToken declarator)
        {
            ...
            if (isReadOnly)
            {
                analyser.ReportError(DiagnosticsCode.LetVariableAndConstMustBeInitialized, tokens[index]);
                return null;
            }

            if (tokens[index] is not ReservedKeywordToken { Keyword: ReservedKeyword.As } asKeyword)
            {
                analyser.ReportError(DiagnosticsCode.ExpectedAsOrEquals, tokens[index]);
                return null;
            }
            ...
            if (tokens[index] is not SyntaxCharacterToken { SyntaxCharacter: SyntaxCharacter.Semicolon } semicolon)
            {
                analyser.ReportError(DiagnosticsCode.ExpectedEqualsOrSemicolon, tokens[index]);
                return null;
            }
